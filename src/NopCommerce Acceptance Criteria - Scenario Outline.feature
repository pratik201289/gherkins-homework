Feature: Book category
  ...
  Background: I should be able to see homepage
    ...
    Scenario Outline:  I should be able to chosen any filter option with specific result
      Given I am on book page
      When  I click on "<filter>"
      ...
      Examples:
            ...
            | Sort by        | Name:low to high          | sorted product with price in descending order                 |
            | Sort by        | Name:high to low          | sorted product with price in ascending order                  |
            | Sort by        | Name:Created On           | Recently added product should be show first                   |
